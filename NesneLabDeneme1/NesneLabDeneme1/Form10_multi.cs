...
namespace NesneLabDeneme1
{
    public partial class Form10_multi : Form
    {
        ...
        private void MessageReceiver_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //BesliyiSil(buttonarraytemp);
            Button[,] serverButton ;

            serverButton = buttonarraytemp;

            ButonlarıDondur(buttonarraytemp);


            BackgroundWorker b1 = new BackgroundWorker();
            b1.DoWork += new DoWorkEventHandler(Button_Click);
            b1.RunWorkerCompleted += new RunWorkerCompletedEventHandler(button1_Click);
